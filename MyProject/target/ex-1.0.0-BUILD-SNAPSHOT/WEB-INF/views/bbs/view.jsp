                    ...
                    <tr>
                        ...
                        <td>
                            <c:if test="${vo.file_name ne null }">
                                <a href="javascript:fileDown('${vo.file_name }')">
                                        ${vo.file_name }
                                </a>
                            </c:if>
                        </td>
...
<script>
    function fileDown(fileName){
        ...
        location.href="FileDownload?dir=/resources/upload&filename="+ encodeURIComponent(fileName);

        //get 방식 한글처리르 하기 위해서는 톰켓의 server.xml에서
        //<Connector port="8080" protocol="HTTP/1.1" URIEncoding="utf-8"
        //<Connector pott="8009" protocol="AJP/1.3" URIEncoding="utf-8"
    }
</script>
</body>
</html>
